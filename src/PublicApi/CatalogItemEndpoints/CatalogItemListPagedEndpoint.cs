...
public class CatalogItemListPagedEndpoint : IEndpoint<IResult, ListPagedCatalogItemRequest>
{
    ...
    public CatalogItemListPagedEndpoint(IUriComposer uriComposer, IMapper mapper, ILogger<CreateCatalogItemEndpoint> logger)
    {
    ...
    public async Task<IResult> HandleAsync(ListPagedCatalogItemRequest request)
    {
        ...
        _logger.LogInformation($"Items count is {items.Count}");
